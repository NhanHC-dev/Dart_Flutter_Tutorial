...
import 'package:quizlet/model/subject.dart';
import 'package:quizlet/presentation/screen/subjectDetail.dart';
        ...
        children: List.generate(subjects.length, (index) {
          return GestureDetector(
            onTap: ()async{
              ...
              var nextPage=true;
              var goForward=true;
              while(nextPage&& index+i<subjects.length && index+i>=0) {
                [nextPage, goForward] = await Navigator.push(context, MaterialPageRoute(builder: (context){
